...
class MRLTests(unittest.TestCase):
    ...
    def test_functionalise_from_nlmaps(self):
        # generic tests
        test_reponse = self.nlmaps_world.functionalise(
        ...
        test_reponse = self.nlmaps_world.functionalise(
            "query@3 area@2 keyval@2 name@0 Heidelberg@s keyval@2 de:place@0 city@s nwr@1 keyval@2 name@0 Mc€Donalds@s qtype@1 count@0"
        )
        ...
        test_reponse = self.nlmaps_world.functionalise(
            "query@2 around@4 center@2 area@2 keyval@2 name@0 Heidelberg@s keyval@2 de:place@0 city@s nwr@1 keyval@2 name@0 Yorckstra\xdfe@s search@1 nwr@1 and@2 keyval@2 amenity@0 bank@s keyval@2 amenity@0 pharmacy@s maxdist@1 DIST_INTOWN@0 topx@1 1@0 qtype@1 latlong@0"
        )
        ...
        test_reponse = self.nlmaps_world.functionalise(
            ...
            non_stemmed="noise noise Paris noise",
            stemmed="noise noise pari noise",
        )
        goal = "query(area(keyval('name','Paris'),keyval('is_in:country','France')),nwr(keyval('cuisine','japanese')),qtype(count))"
        self.assertEqual(
            test_reponse,
        ...
        test_reponse = self.nlmaps_world.functionalise(
            "query@3 area@2 failval@2 name@0 Paris@s keyval@2 is_in:country@0 France@s nwr@1 keyval@2 cuisine@0 japanese@s qtype@1 count@0",
            cfg=self.cfg,
        )
        goal = ""
        self.assertEqual(
        ...
        test_reponse = self.nlmaps_world.functionalise(
            "query@5 area@2 keyval@2 name@0 Paris@s keyval@2 is_in:country@0 France@s nwr@1 keyval@2 cuisine@0 japanese@s qtype@1 count@0"
        )
        goal = ""
        self.assertEqual(
            test_reponse,
    ...
    def test_preprocess_mrl_from_nlmaps(self):
        test_reponse = self.nlmaps_world.preprocess_mrl(
